...
namespace Assignment_2_PIzza_Application
{
    public partial class Form1 : Form
    {
        ...
        private void myToolTip()
        {
            ...
            myToolTip.SetToolTip(cboStarter, "Choose from arange of starters");//Displays text in quotation marks when hovering over combo box
            myToolTip.SetToolTip(button1, " in £");//Displays text in quotation marks when hovering over button
        }

        private void CboStarter_SelectedIndexChanged(object sender, EventArgs e)
        {
            //I've done this so I don't need to
       //   lstOrderreveiw.Items.Add(cboStarter.SelectedItem);//Adds Selected item from Combobox to Listbox
        ...
        {
            lstOrderreveiw.Items.RemoveAt(lstOrderreveiw.SelectedIndex);
        }

        private void btnAdd_Click(object sender, EventArgs e)
        {
            lstOrderreveiw.Items.Add(cboStarter.SelectedItem);
            lstOrderreveiw.Items.Add(cboBase.SelectedItem);
            lstOrderreveiw.Items.Add(cboSweet.SelectedItem);
